...
<div class="page">
    <div class="hero">
        <div class="hero-top">
            <div>
                ...
                <h1>Create Device</h1>
                <p>Add a new device to the master list so incidents can be linked to a clear asset context.</p>
            </div>
    ...
    <div class="panel">
        ...
        <p class="panel-subtitle">Complete the fields below to register a new device.</p>
